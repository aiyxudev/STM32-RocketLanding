...
void f3d_lcd_drawBarclean(uint8_t);
void f3d_lcd_drawBar(uint8_t, uint8_t, uint16_t);
void f3d_lcd_drawBarneg(uint8_t, uint8_t, uint16_t);
...
void f3d_lcd_drawDot(uint8_t, uint8_t, uint16_t);
